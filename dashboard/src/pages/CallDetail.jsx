...
const EVENT_CONFIG = {
  ...
  transfer_failed: { label: 'Transfer falló', color: 'bg-red-400' },
  sip_rejected: { label: 'Rechazada', color: 'bg-red-400' },
  sip_unavailable: { label: 'No disponible', color: 'bg-orange-400' },
