...
import {
  Calendar, MessageCircle, Wrench, Save, TestTube, Check, X,
} from 'lucide-react'

const allTools = [
  { key: 'search_knowledge', label: 'Búsqueda de conocimientos', desc: 'Consultar base de documentos del negocio' },
  { key: 'schedule_appointment', label: 'Agendar citas', desc: 'El agente puede crear citas durante la llamada' },
  { key: 'send_whatsapp', label: 'Enviar WhatsApp', desc: 'Enviar mensajes de confirmación por WhatsApp' },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <div className="space-y-3">
            ...
            >
              ...
              {testingCal ? 'Probando...' : 'Probar conexión'}
            </Button>
          </div>
        </Card>
        ...
        <Card>
          ...
          <p className="text-xs text-text-muted mb-4">
            ...
            (confirmaciones de citas, información, etc).
          </p>
          <div className="space-y-3">
            <Input
              label="URL de API"
      ...
      <Card>
        ...
        <p className="text-xs text-text-muted mb-4">
          Selecciona qué herramientas puede usar el agente de voz durante las llamadas.
        </p>
        <div className="space-y-3">
          {allTools.map(tool => {
