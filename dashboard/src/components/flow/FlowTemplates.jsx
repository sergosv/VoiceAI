...
const TEMPLATES = [
  {
    ...
    edges: [
      { id: 'e1', source: 'start-1', target: 'c-nombre', sourceHandle: 'default', animated: true },
      { id: 'e2', source: 'c-nombre', target: 'c-tel', sourceHandle: 'default', animated: true },
      { id: 'e3', source: 'c-tel', target: 'a-cita', sourceHandle: 'default', animated: true },
      { id: 'e4', source: 'a-cita', target: 'end-1', sourceHandle: 'success', animated: true },
    ],
  },
  {
    ...
    edges: [
      { id: 'e1', source: 'start-1', target: 'c-consulta', sourceHandle: 'default', animated: true },
      { id: 'e2', source: 'c-consulta', target: 'a-buscar', sourceHandle: 'default', animated: true },
      { id: 'e3', source: 'a-buscar', target: 'msg-resp', sourceHandle: 'success', animated: true },
      { id: 'e4', source: 'a-buscar', target: 'transfer-1', sourceHandle: 'failure', animated: true },
      { id: 'e5', source: 'msg-resp', target: 'c-mas', sourceHandle: 'default', animated: true },
  ...
  },
  {
    ...
    edges: [
      { id: 'e1', source: 'start-1', target: 'c-nombre', sourceHandle: 'default', animated: true },
      { id: 'e2', source: 'c-nombre', target: 'c-email', sourceHandle: 'default', animated: true },
      { id: 'e3', source: 'c-email', target: 'c-tel', sourceHandle: 'default', animated: true },
      { id: 'e4', source: 'c-tel', target: 'a-guardar', sourceHandle: 'default', animated: true },
      { id: 'e5', source: 'a-guardar', target: 'end-1', sourceHandle: 'success', animated: true },
    ],
  },
  {
    ...
    edges: [
      { id: 'e1', source: 'start-1', target: 'c-pregunta', sourceHandle: 'default', animated: true },
      { id: 'e2', source: 'c-pregunta', target: 'a-buscar', sourceHandle: 'default', animated: true },
      { id: 'e3', source: 'a-buscar', target: 'msg-resp', sourceHandle: 'success', animated: true },
      { id: 'e4', source: 'msg-resp', target: 'c-otra', sourceHandle: 'default', animated: true },
