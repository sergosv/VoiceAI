...
async def process_inbound_message(msg: InboundMessage) -> None:
    ...
    if msg.ghl_location_id:
        wa_config = await load_whatsapp_config_by_ghl_location(msg.ghl_location_id)
    elif msg.evo_instance_id:
    ...
    # Inyectar datos de GHL para que send_text pueda usarlos
    if msg.ghl_contact_id:
        wa_config["_ghl_contact_id"] = msg.ghl_contact_id
    if msg.channel:
        wa_config["_ghl_channel"] = msg.channel
